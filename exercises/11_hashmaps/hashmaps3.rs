...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        if let Some(team1) = scores.get_mut(team_1_name){
            ...
            //scores.insert(team_1_name, TeamScores { goals_scored: team1.goals_scored, goals_conceded: team1.goals_conceded });
        }
        else{
        ...
        if let Some(team2) = scores.get_mut(team_2_name){
            ...
            //scores.insert(team_2_name, TeamScores { goals_scored: team2.goals_scored, goals_conceded: team2.goals_conceded });
        }
        else{
